...
android {
    namespace = "com.geektcg.tienda"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.geektcg.tienda"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.foundation:foundation")        // ✅ incluye KeyboardOptions y KeyboardType
